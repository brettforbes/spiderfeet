"""Netdiscover text-native adapter for modules_v2 (SPEC-010 / R10-15)."""
...
from modules_v2.adapters.netdiscover.text_to_json import (
    OutputMode,
...
def to_graph(structured: dict[str, Any] | str) -> dict[str, Any]:
    """Build Netdiscover graph via shared ``_core.topology`` helpers."""
