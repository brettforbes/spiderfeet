# -*- coding: utf-8 -*-
"""07B-cited graph hooks for Nerva structured-native adapter (modules_v2 port)."""
...
from modules_v2._core.correlation_engine import RecordCorrelationResult, correlate_nerva_records
