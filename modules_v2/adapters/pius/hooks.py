# -*- coding: utf-8 -*-
"""08-cited graph hooks for Pius structured-native adapter (modules_v2 port)."""
...
from modules_v2._core.pius_lists import load_pius_lists
from modules_v2.adapters.pius.classify import EntityClassification, classify_record, is_domain_shape
...
class _PiusContext:
    ...
    def ensure_company(self) -> dict[str, Any] | None:
        ...
        from modules_v2._core.topology import add_company_domain_tree
