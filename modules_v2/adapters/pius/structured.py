# -*- coding: utf-8 -*-
"""Pius structured JSON helpers and structured→text conversion (modules_v2 port)."""
...
# Alias matching other JSONL adapters (nerva/subfinder).
parse_jsonl = parse_ndjson


def parse_pius_structured(raw: str) -> dict[str, Any]:
    """Parse pius bundle JSON or legacy NDJSON into {schema, records, …meta}."""
    stripped = raw.strip()
    if not stripped:
