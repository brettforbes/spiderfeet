"""Nmap structured-native adapter for modules_v2 (SPEC-010 / R10-14)."""
...
from modules_v2.adapters.nmap.hooks import apply_nmap_hosts
from modules_v2.adapters.nmap.intermediate import parse_nmap_xml
...
def to_graph(structured: dict[str, Any] | str) -> dict[str, Any]:
    ...
    doc = _structured_doc(structured)
    rule_pack = load_rule_pack(mapping_path("nmap"), shared_dir=SHARED_RULES_DIR)
