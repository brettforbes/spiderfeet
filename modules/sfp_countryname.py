...
class sfp_countryname(SpiderFeetPlugin):
    ...
    def detectCountryFromPhone(self, srcPhoneNumber: str) -> str:
        ...
        return SpiderFeetHelpers.countryNameFromCountryCode(countryCode.upper())
    ...
    def detectCountryFromDomainName(self, srcDomain: str) -> str:
        ...
        for part in domainParts[::-1]:
            country_name = SpiderFeetHelpers.countryNameFromTld(part)
            if country_name:
                return country_name
    ...
    def detectCountryFromIBAN(self, srcIBAN: str) -> str:
        ...
        return SpiderFeetHelpers.countryNameFromCountryCode(srcIBAN[0:2])
    ...
    def detectCountryFromData(self, srcData: str) -> list:
        ...
        abbvCountryCodes = SpiderFeetHelpers.countryCodes()
    ...
    def handleEvent(self, event):
        ...
        for countryName in set(countryNames):
            ...
            evt = SpiderFeetEvent("COUNTRY_NAME", countryName, self.__name__, event)
