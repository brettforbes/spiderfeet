...
# Purpose:     SpiderFeet plug-in for using the WAFW00F tool.
...
class sfp_tool_wafw00f(SpiderFeetPlugin):
    meta = {
        'name': "Tool - WAFW00F",
    ...
    def handleEvent(self, event):
        ...
        evt = SpiderFeetEvent('RAW_RIR_DATA', json.dumps(result_json), self.__name__, event)
