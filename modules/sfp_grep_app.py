...
class sfp_grep_app(SpiderFeetPlugin):
    ...
    def handleEvent(self, event):
        ...
        while page <= pages:
            ...
            for result in data:
                ...
                evt = SpiderFeetEvent("RAW_RIR_DATA", str(result), self.__name__, event)
                ...
                emails = SpiderFeetHelpers.extractEmailsFromText(snippet.replace('<mark>', '').replace('</mark>', ''))
                if emails:
                    for email in emails:
