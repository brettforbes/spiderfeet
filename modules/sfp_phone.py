...
class sfp_phone(SpiderFeetPlugin):
    ...
    def handleEvent(self, event):
        ...
        if eventName in ['TARGET_WEB_CONTENT', 'DOMAIN_WHOIS', 'NETBLOCK_WHOIS']:
            ...
            for match in phonenumbers.PhoneNumberMatcher(content, region=None):
                ...
                evt = SpiderFeetEvent("PHONE_NUMBER", n, self.__name__, event)
        ...
        if eventName == 'PHONE_NUMBER':
            ...
            evt = SpiderFeetEvent("PROVIDER_TELCO", number_carrier, self.__name__, event)
