...
class sfp_binaryedge(SpiderFeetPlugin):
    ...
    def handleEvent(self, event):
        ...
        if eventName == "EMAILADDR":
            ...
            for rec in ret:
                ...
                for leak in events:
                    e = SpiderFeetEvent('EMAILADDR_COMPROMISED', f"{eventData} [{leak}]", self.__name__, event)
        ...
        if eventName == "DOMAIN_NAME":
            ...
            for rec in ret:
                ...
                for rec in events:
                    ...
                    e = SpiderFeetEvent('INTERNET_NAME', rec, self.__name__, event)
                    self.notifyListeners(e)
        ...
        for addr in qrylist:
            ...
            for rec in ret:
                ...
                for rec in events:
                    ...
                    e = SpiderFeetEvent('MALICIOUS_IPADDR', dat, self.__name__, event)
                    self.notifyListeners(e)
                ...
                for rec in results:
                    ...
                    if cves:
                        for c in cves:
                            ...
                            e = SpiderFeetEvent(etype, cvetext, self.__name__, event)
                            self.notifyListeners(e)
                ...
                for res in events:
                    for prec in res['results']:
                        ...
                        if f"{evttype}:{port}" not in ports:
                            ev = SpiderFeetEvent(evttype, entity, self.__name__, event)
                        ...
                        e = SpiderFeetEvent(evtbtype, banner, self.__name__, ev)
                        self.notifyListeners(e)
