...
class TestSf(unittest.TestCase):
    ...
    def test_debug_arg_should_enable_and_print_debug_output(self):
        out, err, code = self.execute([sys.executable, "sf.py", "-d", "-m", "example module", "-s", "spiderfeet.net"])
    ...
    def test_quiet_arg_should_hide_debug_output(self):
        out, err, code = self.execute([sys.executable, "sf.py", "-q", "-m", "example module", "-s", "spiderfeet.net"])
    ...
    def test_run_scan_should_print_scan_result_and_exit(self):
        ...
        expected_output = [
            "Source,Type,Data",
            "SpiderFoot UI,Internet Name,spiderfeet.net,spiderfeet.net\n",
            "SpiderFoot UI,Domain Name,spiderfeet.net,spiderfeet.net\n",
