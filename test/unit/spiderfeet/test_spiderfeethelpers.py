...
class TestSpiderfeetHelpers(unittest.TestCase):
    ...
    def test_target_type(self):
        ...
        target_type = SpiderFootHelpers.targetTypeFromString("noreply@spiderfeet.net")
        ...
        target_type = SpiderFootHelpers.targetTypeFromString("spiderfeet.net")
    ...
    def test_extractEmailsFromText_should_return_list_of_emails_from_string(self):
        emails = SpiderFootHelpers.extractEmailsFromText("<html><body><p>From:noreply@spiderfeet.net</p><p>Subject:Hello user@spiderfeet.net, here's some text</p></body></html>")
    ...
    def test_extractUrlsFromText_should_extract_urls_from_string(self):
        ...
        urls = SpiderFootHelpers.extractUrlsFromText("abchttps://example.spiderfeet.net/path\rabchttp://example.spiderfeet.net:1337/path\rabc")
