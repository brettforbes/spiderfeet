...
class SpiderFeetWebUi:
    ...
    def __init__(self: 'SpiderFeetWebUi', web_config: dict, config: dict, loggingQueue: 'logging.handlers.QueueListener' = None) -> None:
        ...
        dbh = SpiderFeetDb(self.defaultConfig, init=True)
        sf = SpiderFeet(self.defaultConfig)
    ...
    def error_page(self: 'SpiderFeetWebUi') -> None:
        """Error page."""
    ...
    def error_page_401(self: 'SpiderFeetWebUi', status: str, message: str, traceback: str, version: str) -> str:
    ...
    def error_page_404(self: 'SpiderFeetWebUi', status: str, message: str, traceback: str, version: str) -> str:
        ...
        """
        templ = Template(filename='spiderfeet/templates/error.tmpl', lookup=self.lookup)
        return templ.render(message='Not Found', docroot=self.docroot, status=status, version=__version__)

    def jsonify_error(self: 'SpiderFeetWebUi', status: str, message: str) -> dict:
    ...
    def error(self: 'SpiderFeetWebUi', message: str) -> None:
    ...
    def cleanUserInput(self: 'SpiderFeetWebUi', inputList: list) -> list:
    ...
    def searchBase(self: 'SpiderFeetWebUi', id: str = None, eventType: str = None, value: str = None) -> list:
        """Search.
    ...
    def buildExcel(self: 'SpiderFeetWebUi', data: list, columnNames: list, sheetNameIndex: int = 0) -> str:
    ...
    @cherrypy.expose
    def scanexportlogs(self: 'SpiderFeetWebUi', id: str, dialect: str = "excel") -> bytes:
        """Get scan log
    ...
    @cherrypy.expose
    def scancorrelationsexport(self: 'SpiderFeetWebUi', id: str, filetype: str = "csv", dialect: str = "excel") -> str:
    ...
    @cherrypy.expose
    def scaneventresultexport(self: 'SpiderFeetWebUi', id: str, type: str, filetype: str = "csv", dialect: str = "excel") -> str:
    ...
    @cherrypy.expose
    def scaneventresultexportmulti(self: 'SpiderFeetWebUi', ids: str, filetype: str = "csv", dialect: str = "excel") -> str:
    ...
    @cherrypy.expose
    def scansearchresultexport(self: 'SpiderFeetWebUi', id: str, eventType: str = None, value: str = None, filetype: str = "csv", dialect: str = "excel") -> str:
    ...
    @cherrypy.expose
    def scanexportjsonmulti(self: 'SpiderFeetWebUi', ids: str) -> str:
    ...
    @cherrypy.expose
    def scanviz(self: 'SpiderFeetWebUi', id: str, gexf: str = "0") -> str:
        ...
        if gexf == "0":
            return SpiderFeetHelpers.buildGraphJson([root], data)
        ...
        cherrypy.response.headers['Pragma'] = "no-cache"
        return SpiderFeetHelpers.buildGraphGexf([root], "SpiderFeet Export", data)

    @cherrypy.expose
    def scanvizmulti(self: 'SpiderFeetWebUi', ids: str, gexf: str = "1") -> str:
        ...
        cherrypy.response.headers['Content-Type'] = "application/gexf"
        cherrypy.response.headers['Pragma'] = "no-cache"
        return SpiderFeetHelpers.buildGraphGexf(roots, "SpiderFeet Export", data)

    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scanopts(self: 'SpiderFeetWebUi', id: str) -> dict:
    ...
    @cherrypy.expose
    def rerunscan(self: 'SpiderFeetWebUi', id: str) -> None:
        """Rerun a scan.
        ...
        targetType = SpiderFeetHelpers.targetTypeFromString(scantarget)
        if not targetType:
            ...
            # target type again.
            targetType = SpiderFeetHelpers.targetTypeFromString(f'"{scantarget}"')
        ...
        try:
            p = mp.Process(target=startSpiderFeetScanner, args=(self.loggingQueue, scanname, scanId, scantarget, targetType, modlist, cfg))
            p.daemon = True
            p.start()
    ...
    @cherrypy.expose
    def rerunscanmulti(self: 'SpiderFeetWebUi', ids: str) -> str:
        """Rerun scans.
        ...
        templ = Template(filename='spiderfeet/templates/scanlist.tmpl', lookup=self.lookup)
        return templ.render(rerunscans=True, docroot=self.docroot, pageid="SCANLIST", version=__version__)

    @cherrypy.expose
    def newscan(self: 'SpiderFeetWebUi') -> str:
        ...
        templ = Template(filename='spiderfeet/templates/newscan.tmpl', lookup=self.lookup)
        return templ.render(pageid='NEWSCAN', types=types, docroot=self.docroot,
                            modules=self.config['__modules__'], scanname="",
                            selectedmods="", scantarget="", version=__version__)

    @cherrypy.expose
    def clonescan(self: 'SpiderFeetWebUi', id: str) -> str:
    ...
    @cherrypy.expose
    def index(self: 'SpiderFeetWebUi') -> str:
        """Show scan list page.
    ...
    @cherrypy.expose
    def scaninfo(self: 'SpiderFeetWebUi', id: str) -> str:
        ...
        templ = Template(filename='spiderfeet/templates/scaninfo.tmpl', lookup=self.lookup, input_encoding='utf-8')
        return templ.render(id=id, name=html.escape(res[0]), status=res[5], docroot=self.docroot, version=__version__,
                            pageid="SCANLIST")

    @cherrypy.expose
    def opts(self: 'SpiderFeetWebUi', updated: str = None) -> str:
        ...
        """
        templ = Template(filename='spiderfeet/templates/opts.tmpl', lookup=self.lookup)
    ...
    @cherrypy.expose
    def optsexport(self: 'SpiderFeetWebUi', pattern: str = None) -> str:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def optsraw(self: 'SpiderFeetWebUi') -> str:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scandelete(self: 'SpiderFeetWebUi', id: str) -> str:
        """Delete scan(s).
    ...
    @cherrypy.expose
    def savesettings(self: 'SpiderFeetWebUi', allopts: str, token: str, configFile: 'cherrypy._cpreqbody.Part' = None) -> None:
    ...
    @cherrypy.expose
    def savesettingsraw(self: 'SpiderFeetWebUi', allopts: str, token: str) -> str:
        """Save settings, also used to completely reset them to default.
    ...
    def reset_settings(self: 'SpiderFeetWebUi') -> bool:
    ...
    @cherrypy.expose
    def resultsetfp(self: 'SpiderFeetWebUi', id: str, resultids: str, fp: str) -> str:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def eventtypes(self: 'SpiderFeetWebUi') -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def modules(self: 'SpiderFeetWebUi') -> list:
        """List all modules.
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def correlationrules(self: 'SpiderFeetWebUi') -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def ping(self: 'SpiderFeetWebUi') -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def query(self: 'SpiderFeetWebUi', query: str) -> str:
    ...
    @cherrypy.expose
    def startscan(self: 'SpiderFeetWebUi', scanname: str, scantarget: str, modulelist: str, typelist: str, usecase: str) -> str:
        """Initiate a scan.
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def stopscan(self: 'SpiderFeetWebUi', id: str) -> str:
        """Stop a scan.
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scanlog(self: 'SpiderFeetWebUi', id: str, limit: str = None, rowId: str = None, reverse: str = None) -> list:
        """Scan log data.
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scanerrors(self: 'SpiderFeetWebUi', id: str, limit: str = None) -> list:
        """Scan error data.
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scanlist(self: 'SpiderFeetWebUi') -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scanstatus(self: 'SpiderFeetWebUi', id: str) -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scansummary(self: 'SpiderFeetWebUi', id: str, by: str) -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scancorrelations(self: 'SpiderFeetWebUi', id: str) -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scaneventresults(self: 'SpiderFeetWebUi', id: str, eventType: str = None, filterfp: bool = False, correlationId: str = None) -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scaneventresultsunique(self: 'SpiderFeetWebUi', id: str, eventType: str, filterfp: bool = False) -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def search(self: 'SpiderFeetWebUi', id: str = None, eventType: str = None, value: str = None) -> list:
        """Search scans.
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scanhistory(self: 'SpiderFeetWebUi', id: str) -> list:
    ...
    @cherrypy.expose
    @cherrypy.tools.json_out()
    def scanelementtypediscovery(self: 'SpiderFeetWebUi', id: str, eventType: str) -> dict:
        ...
        del pc['ROOT']
        retdata['tree'] = SpiderFeetHelpers.dataParentChildToTree(pc)
