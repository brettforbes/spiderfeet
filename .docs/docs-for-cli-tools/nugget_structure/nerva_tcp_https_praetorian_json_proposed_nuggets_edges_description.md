# Nerva scan narrative — `tcp_https_praetorian_json`
...
Every examination has one SCAN_RECORD with scan descriptors linked via had. This scan includes **1** Scan root node(s) (e.g. `nerva:praetorian.com:443:2026-06-30T07:38:59.526006+00:00`). Linked structures: `SCAN_CLI`, `SCAN_TARGET`, `SCAN_START`, `SCAN_ELAPSED`, `SCAN_EXIT_STATUS`, `SCAN_TOOL`.
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_cli_2["SCAN_CLI: nerva -t praetorian.com:443 --json --mi…"]
  scan_record_1 -->|contains| scan_cli_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_CLI` | `nerva -t praetorian.com:443 --json --misconfigs -w 8000` |
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_start_2["SCAN_START: 2026-06-30T07:38:59.526006+00:00"]
  scan_record_1 -->|contains| scan_start_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_START` | `2026-06-30T07:38:59.526006+00:00` |
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_elapsed_2["SCAN_ELAPSED: 25.312"]
...
| `DOMAIN_NAME` | `www.praetorian.com` |
| `EDGE_DURATION_MS` | `219` |
| `EDGE_DURATION_MS` | `234` |
| `EDGE_DURATION_MS` | `424` |
| `EDGE_DURATION_MS` | `434` |
| `EDGE_NODE_ID` | `a13b83d378e7cd04-SYD` |
| `EDGE_NODE_ID` | `a13b83d3994fa96d-SYD` |
| `EDGE_NODE_ID` | `a13b83d39c0760db-SYD` |
| `EDGE_NODE_ID` | `a13b83d6cfd2f6fb-SYD` |
...
| `SCAN_ELAPSED` | `25.312` |
| `SCAN_EXIT_STATUS` | `0` |
| `SCAN_RECORD` | `nerva:praetorian.com:443:2026-06-30T07:38:59.526006+00:00` |
| `SCAN_START` | `2026-06-30T07:38:59.526006+00:00` |
| `SCAN_TARGET` | `praetorian.com:443` |
| `SCAN_TOOL` | `nerva` |
| `SERVICE` | `https` |
