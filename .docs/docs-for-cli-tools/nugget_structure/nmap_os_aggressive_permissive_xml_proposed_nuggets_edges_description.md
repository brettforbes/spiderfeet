# Nmap scan narrative — `os_aggressive_permissive_xml`
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_cli_2["SCAN_CLI: nmap -sT -A -T3 -p 22,80,443 -oX - scan…"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_start_2["SCAN_START: Tue Jun 23 19:01:10 2026"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_summary_2["SCAN_SUMMARY: Nmap done at Tue Jun 23 19:01:35 2026; …"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_elapsed_2["SCAN_ELAPSED: 25.71"]
