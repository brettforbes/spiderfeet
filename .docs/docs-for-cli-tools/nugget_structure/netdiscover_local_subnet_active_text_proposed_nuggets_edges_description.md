...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_end_time_2["SCAN_END_TIME: Sun Aug 09 15:54:40 2026"]
  scan_record_1 -->|contains| scan_end_time_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_END_TIME` | `Sun Aug 09 15:54:40 2026` |
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_summary_2["SCAN_SUMMARY: NetDiscover done at Sun Aug 09 15:54:40…"]
  scan_record_1 -->|contains| scan_summary_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_SUMMARY` | `NetDiscover done at Sun Aug 09 15:54:40 2026; 12 Systems Discovered, 5 Scan Tries, 3 Empty Scans, scanned in 15.81 seconds` |
