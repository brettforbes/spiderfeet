# Nmap scan narrative — `tcp_top_ports_permissive_xml`
...
Every examination has one SCAN_RECORD with scan descriptors linked via had. This scan includes **1** Scan root node(s) (e.g. `nmap:scanme.nmap.org:Tue Jun 23 18:58:01 2026`). Linked structures: `SCAN_CLI`, `SCAN_VERSION`, `SCAN_START`, `SCAN_TARGET`, `SCAN_SUMMARY`, `SCAN_ELAPSED`.
...
flowchart TD
  ...
  service_2["SERVICE: Elite"]
  applications_1 -->|contains| service_2
  service_3["SERVICE: http"]
