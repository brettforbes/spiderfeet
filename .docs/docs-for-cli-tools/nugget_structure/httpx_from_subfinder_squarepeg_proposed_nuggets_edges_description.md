...
Every examination has one SCAN_RECORD with scan descriptors linked via had. This scan includes **1** Scan root node(s) (e.g. `httpx:squarepeg.vc:httpx -l .docs/docs-for-cli-tools/exploration_scratch/httpx/hosts/from_subfinder_squarepeg_hosts.txt -status-code -title -tech-detect -server -cdn -ip -json -no-stdin -o .docs/docs-for-cli-tools/exploration_scratch/httpx/exams/from_subfinder_squarepeg.jsonl -silent -threads 15 -timeout 15 -rate-limit 30`). Linked structures: `SCAN_CLI`, `SCAN_TARGET`, `SCAN_PROBE_PROFILE`, `SCAN_HOST_INPUT_COUNT`, `SCAN_START`, `SCAN_ELAPSED`.
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_host_input_count_2["SCAN_HOST_INPUT_COUNT: 7"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_start_2["SCAN_START: 2026-07-05T16:04:57.955640+00:00"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_elapsed_2["SCAN_ELAPSED: 3.078"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  upstream_scenario_id_2["UPSTREAM_SCENARIO_ID: corporate_squarepeg_passive_cs"]
...
Qualified HOST endpoints own category trees for networks, applications, environment, and security findings. This scan includes **2** Host root node(s) (e.g. `54.38.64.116`, `198.202.211.1`). Linked structures: `NETWORKS`, `APPLICATIONS`.
...
flowchart TD
  networks_1["NETWORKS"]
  ipv4_address_2["IPV4_ADDRESS: 104.18.5.54"]
  networks_1 -->|contains| ipv4_address_2
  ipv4_address_3["IPV4_ADDRESS: 172.67.212.142"]
  networks_1 -->|contains| ipv4_address_3
  ipv4_address_4["IPV4_ADDRESS: 198.202.211.1"]
...
| Nugget | Value |
| --- | --- |
| `IPV4_ADDRESS` | `104.18.5.54` |
| `IPV4_ADDRESS` | `172.67.212.142` |
| `IPV4_ADDRESS` | `198.202.211.1` |
| `IPV4_ADDRESS` | `3.169.183.60` |
| `IPV4_ADDRESS` | `34.111.99.212` |
| `IPV4_ADDRESS` | `54.38.64.116` |
...
CDN edge endpoints replace HOST when fronting is detected; origin host count may be indeterminate. This scan includes **4** CDN root node(s) (e.g. `172.67.212.142`, `34.111.99.212`, `3.169.183.79`). Linked structures: `NETWORKS`, `APPLICATIONS`.
...
Apex DOMAIN_NAME entities contain subdomain DOMAIN_NAME children; descriptors capture discovery mode, sources, and liveness. This scan includes **12** Domains root node(s) (e.g. `squarepeg.vc`, `static.squarepeg.vc`, `data.squarepeg.vc`). Linked structures: `DOMAIN_NAME`.
...
flowchart TD
  domain_name_1["DOMAIN_NAME"]
  domain_name_2["DOMAIN_NAME: cdn.webflow.com"]
  domain_name_1 -->|contains| domain_name_2
  domain_name_3["DOMAIN_NAME: d2rqjm78y4sxx.cloudfront.net"]
  domain_name_1 -->|contains| domain_name_3
  domain_name_4["DOMAIN_NAME: default-proxy-fallback.getproven.com"]
...
| `IPV4_ADDRESS` | `104.18.4.54` |
| `IPV4_ADDRESS` | `104.18.5.54` |
| `IPV4_ADDRESS` | `104.21.85.245` |
| `IPV4_ADDRESS` | `172.67.212.142` |
| `IPV4_ADDRESS` | `198.202.211.1` |
| `IPV4_ADDRESS` | `3.169.183.3` |
| `IPV4_ADDRESS` | `3.169.183.60` |
| `IPV4_ADDRESS` | `3.169.183.79` |
| `IPV4_ADDRESS` | `3.169.183.88` |
| `IPV4_ADDRESS` | `34.111.99.212` |
| `IPV4_ADDRESS` | `54.38.64.116` |
| `IS_ERROR_PAGE` | `true` |
| `LINE_COUNT` | `1` |
