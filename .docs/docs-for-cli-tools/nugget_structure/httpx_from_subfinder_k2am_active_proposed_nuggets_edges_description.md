# Httpx scan narrative — `from_subfinder_k2am_active`
...
Every examination has one SCAN_RECORD with scan descriptors linked via had. This scan includes **1** Scan root node(s) (e.g. `httpx:k2am.com.au:httpx -l .docs/docs-for-cli-tools/exploration_scratch/httpx/hosts/from_subfinder_k2am_active_hosts.txt -status-code -title -tech-detect -server -cdn -ip -json -no-stdin -o .docs/docs-for-cli-tools/exploration_scratch/httpx/exams/from_subfinder_k2am_active.jsonl -silent -threads 10 -timeout 15 -rate-limit 25`). Linked structures: `SCAN_CLI`, `SCAN_TARGET`, `SCAN_PROBE_PROFILE`, `SCAN_HOST_INPUT_COUNT`, `SCAN_START`, `SCAN_ELAPSED`.
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_host_input_count_2["SCAN_HOST_INPUT_COUNT: 8"]
  scan_record_1 -->|contains| scan_host_input_count_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_HOST_INPUT_COUNT` | `8` |
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_start_2["SCAN_START: 2026-07-05T16:05:25.313018+00:00"]
  scan_record_1 -->|contains| scan_start_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_START` | `2026-07-05T16:05:25.313018+00:00` |
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_elapsed_2["SCAN_ELAPSED: 21.719"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  upstream_scenario_id_2["UPSTREAM_SCENARIO_ID: corporate_k2am_active_oI"]
  scan_record_1 -->|contains| upstream_scenario_id_2
```

| Nugget | Value |
| --- | --- |
| `UPSTREAM_SCENARIO_ID` | `corporate_k2am_active_oI` |
...
flowchart TD
  ...
  ipv4_address_3["IPV4_ADDRESS: 170.187.131.209"]
...
| `PROBE_FAILED` | `False` |
| `PROBE_TIMESTAMP` | `2026-07-06T02:05:27.0555462+10:00` |
| `PROBE_TIMESTAMP` | `2026-07-06T02:05:27.0613983+10:00` |
| `PROBE_TIMESTAMP` | `2026-07-06T02:05:27.2381681+10:00` |
| `PROBE_TIMESTAMP` | `2026-07-06T02:05:27.9694647+10:00` |
| `RESPONSE_TIME_MS` | `112.8361ms` |
| `RESPONSE_TIME_MS` | `21.5801ms` |
| `RESPONSE_TIME_MS` | `24.3817ms` |
| `RESPONSE_TIME_MS` | `962.2835ms` |
| `SCAN_CLI` | `httpx -l .docs/docs-for-cli-tools/exploration_scratch/httpx/hosts/from_subfinder_k2am_active_hosts.txt -status-code -title -tech-detect -server -cdn -ip -json -no-stdin -o .docs/docs-for-cli-tools/exploration_scratch/httpx/exams/from_subfinder_k2am_active.jsonl -silent -threads 10 -timeout 15 -rate-limit 25` |
| `SCAN_ELAPSED` | `21.719` |
| `SCAN_EXIT_STATUS` | `0` |
| `SCAN_HOST_INPUT_COUNT` | `8` |
