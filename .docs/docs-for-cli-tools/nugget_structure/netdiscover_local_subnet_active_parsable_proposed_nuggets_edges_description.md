# Netdiscover scan narrative — `local_subnet_active_parsable`
...
Every examination has one SCAN_RECORD with scan descriptors linked via had. This scan includes **1** Scan root node(s) (e.g. `netdiscover — A — active ARP scan 192.168.1.0/24 (parseable)`). Linked structures: `SCAN_CLI`, `SCAN_TIMESTAMP`, `SCAN_END_TIME`, `SCAN_SUMMARY`, `SCAN_EXIT_STATUS`, `SCAN_TRIES`.
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_cli_2["SCAN_CLI: netdiscover — A — active ARP scan 192.1…"]
  scan_record_1 -->|contains| scan_cli_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_CLI` | `netdiscover — A — active ARP scan 192.168.1.0/24 (parseable)` |
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_end_time_2["SCAN_END_TIME: Sun Aug 09 15:54:42 2026"]
  scan_record_1 -->|contains| scan_end_time_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_END_TIME` | `Sun Aug 09 15:54:42 2026` |
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_summary_2["SCAN_SUMMARY: NetDiscover done at Sun Aug 09 15:54:42…"]
  scan_record_1 -->|contains| scan_summary_2
```

| Nugget | Value |
| --- | --- |
| `SCAN_SUMMARY` | `NetDiscover done at Sun Aug 09 15:54:42 2026; 12 Systems Discovered, 1 Scan Tries, 0 Empty Scans, scanned in 17.20 seconds` |
...
| `SCAN_END_TIME` | `Sun Aug 09 15:54:42 2026` |
| `SCAN_EXIT_STATUS` | `success` |
| `SCAN_RECORD` | `netdiscover — A — active ARP scan 192.168.1.0/24 (parseable)` |
| `SCAN_SUMMARY` | `NetDiscover done at Sun Aug 09 15:54:42 2026; 12 Systems Discovered, 1 Scan Tries, 0 Empty Scans, scanned in 17.20 seconds` |
| `SCAN_TIMESTAMP` | `Sun Aug 09 15:54:24 2026` |
| `SCAN_TRIES` | `1` |
| `SYSTEM` | `192.168.1.1` |
