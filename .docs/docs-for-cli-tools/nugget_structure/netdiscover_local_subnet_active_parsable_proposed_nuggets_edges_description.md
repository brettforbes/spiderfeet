...
| `SCAN_DISCOVERED` | `12` |
| `SCAN_EMPTY_SCANS` | `0` |
| `SCAN_END_TIME` | `Sun Aug 09 15:44:00 2026` |
| `SCAN_EXIT_STATUS` | `success` |
| `SCAN_RECORD` | `netdiscover — A — active ARP scan 192.168.1.0/24 (parseable)` |
| `SCAN_SUMMARY` | `NetDiscover done at Sun Aug 09 15:44:00 2026; 12 Systems Discovered, 1 Scan Tries, 0 Empty Scans, scanned in 17.20 seconds` |
