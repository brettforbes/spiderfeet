...
This report summarizes a Nerva fingerprint capture after Rulesets A/C/B qualification. **3** system node(s) were emitted (1 HOST, 2 CDN).
...
Detected vendor(s): **Cloudflare, Netlify**.
