...
Every examination has one SCAN_RECORD with scan descriptors linked via had. This scan includes **1** Scan root node(s) (e.g. `pius:British Broadcasting Corporation:/mnt/c/projects/spiderfeet/.tools/pius run --org "British Broadcasting Corporation" --domain bbc.co.uk --plugins gleif,wikidata,whois,crt-sh --output ndjson`). Linked structures: `SCAN_CLI`, `SCAN_TARGET`, `SCAN_TARGET_ORG`, `SCAN_START`, `SCAN_ELAPSED`, `SCAN_EXIT_STATUS`.
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_target_org_2["SCAN_TARGET_ORG: British Broadcasting Corporation"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_start_2["SCAN_START: 2026-06-30T04:11:35.192041+00:00"]
...
flowchart TD
  scan_record_1["SCAN_RECORD"]
  scan_elapsed_2["SCAN_ELAPSED: 56.829"]
...
Organisation scans root at COMPANY_NAME with category buckets for domains, netblocks, and research leads. This scan includes **1** Organization root node(s) (e.g. `British Broadcasting Corporation`). Linked structures: `DOMAINS`, `LEADS`.
...
flowchart TD
  ...
  leads_3["LEADS"]
  company_name_1 -->|contains| leads_3
```
...
flowchart TD
  domains_1["DOMAINS"]
  domain_name_2["DOMAIN_NAME: 24hrhack.test.tools.bbc.co.uk"]
  domains_1 -->|contains| domain_name_2
  domain_name_3["DOMAIN_NAME: 24hrhack.tools.bbc.co.uk"]
  domains_1 -->|contains| domain_name_3
  domain_name_4["DOMAIN_NAME: 2entertain.co.uk"]
...
flowchart TD
  leads_1["LEADS"]
  candidate_entity_2["CANDIDATE_ENTITY: 2 Entertain"]
  leads_1 -->|contains| candidate_entity_2
  candidate_entity_3["CANDIDATE_ENTITY: 2BD"]
  leads_1 -->|contains| candidate_entity_3
  candidate_entity_4["CANDIDATE_ENTITY: Adaptive prediction of coefficients of …"]
  leads_1 -->|contains| candidate_entity_4
  more_5["+120 more"]
...
Apex DOMAIN_NAME entities contain subdomain DOMAIN_NAME children; descriptors capture discovery mode, sources, and liveness. This scan includes **1359** Domains root node(s) (e.g. `bbc.co.uk`, `www.bbc.co.uk`, `bbcweb3hytmzhn5d532owbu6oqadra5z3ar726vq5kgwwn6aucdccrad.onion`). Linked structures: no child categories.
