# Nmap scan narrative — `capstone_permissive_xml`
...
Every examination has one SCAN_RECORD with scan descriptors linked via had. This scan includes **1** Scan root node(s) (e.g. `nmap:scanme.nmap.org:Fri Jun 26 03:56:04 2026`). Linked structures: `SCAN_CLI`, `SCAN_VERSION`, `SCAN_START`, `SCAN_TARGET`, `SCAN_SUMMARY`, `SCAN_ELAPSED`.
...
| `OPERATING_SYSTEM` | `Linux 2.6.32 or 3.10` |
| `OPERATING_SYSTEM` | `Linux 3.4` |
| `OPERATING_SYSTEM` | `Linux 3.5` |
| `OPERATING_SYSTEM` | `Linux 3.7` |
...
APPLICATION services listen-to PORT entities under NETWORKS/TRANSPORT. This scan includes **4** Services and ports root node(s) (e.g. `ssh`, `http`, `nping-echo`). Linked structures: no child categories.
...
| `CPE_URL` | `cpe:/a:synology:diskstation_manager:5.1` |
...
| `CPE_URL` | `cpe:/o:linux:linux_kernel:3.10` |
| `CPE_URL` | `cpe:/o:linux:linux_kernel:3.4` |
| `CPE_URL` | `cpe:/o:linux:linux_kernel:3.5` |
| `CPE_URL` | `cpe:/o:linux:linux_kernel:3.7` |
| `CPE_URL` | `cpe:/o:linux:linux_kernel:4.2` |
| `CPE_URL` | `cpe:/o:linux:linux_kernel:4.4` |
