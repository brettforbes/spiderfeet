...
A reference guide for node types, colours, and icon conventions used in the SpiderFoot nugget force graph.
...
|------|-----------|-------------|------|--------|-----------|
| <img src="nugget_icons/icon_root.svg" width="40" height="40" alt="" /> | `ROOT` | Internal SpiderFoot Root event | INTERNAL | `#8B5CF6` | `icon_root.svg` |
...
*Generated from SpiderFoot core_nugget_list. Total: 167 nuggets across 5 types.*
