# Creating a Skill and Documentation for NTLMRecon, Scanning Networks and Systems

I want you to help me author an AI Agent Skill for my library.

## Goal

Create a SKILL.md file and a precise trigger description for NTLMRecon, when we are scanning networks and systems.

This skill will teach you how to use NTLMRecon in different reconnaissance and analysis scenarios.

You will use this skill to exercise NTLMRecon in different scenarios, and over time you will update it with your learnings and insights.
...
- [https://github.com/praetorian-inc/NTLMRecon](https://github.com/praetorian-inc/NTLMRecon)
- [https://github.com/praetorian-inc/NTLMRecon/blob/main/README.md](https://github.com/praetorian-inc/NTLMRecon/blob/main/README.md)
- [https://github.com/praetorian-inc/NTLMRecon/releases](https://github.com/praetorian-inc/NTLMRecon/releases)

Ecosystem references:

- [https://github.com/pwnfoo/NTLMRecon](https://github.com/pwnfoo/NTLMRecon)
- [https://kb.offsec.nl/tools/other/ntlmrecon/](https://kb.offsec.nl/tools/other/ntlmrecon/)
- [https://pentesttools.net/ntlmrecon-enumerate-information-from-ntlm-authentication/](https://pentesttools.net/ntlmrecon-enumerate-information-from-ntlm-authentication/)
...
2. SKILL.md Content (`.cursor\skills\NTLMRecon\SKILL.md`): Deconstruct the workflows from source docs into clear, step-by-step instructions for the AI. Organize it using the following headers:
...
3. References Directory (`.cursor\skills\NTLMRecon\references`): A directory of references to source material and usage, indexed through `SKILLS.md`.
4. Zero to Hero Document (`.docs\docs-for-cli-tools\NTLMRecon-Zero-to-Hero.md`): A markdown document that takes the user from zero to hero in using NTLMRecon.
5. CLI Options Documentation (`.docs\docs-for-cli-tools\NTLMRecon-CLI-Options.md`): A markdown document that lists standard and advanced NTLMRecon CLI options.
