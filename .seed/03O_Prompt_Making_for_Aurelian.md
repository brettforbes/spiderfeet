# Creating a Skill and Documentation for Aurelian, Scanning Networks and Systems

I want you to help me author an AI Agent Skill for my library.

## Goal

Create a SKILL.md file and a precise trigger description for Aurelian, when we are scanning networks and systems.

This skill will teach you how to use Aurelian in different reconnaissance and analysis scenarios.

You will use this skill to exercise Aurelian in different scenarios, and over time you will update it with your learnings and insights.
...
- [https://github.com/praetorian-inc/aurelian](https://github.com/praetorian-inc/aurelian)
- [https://github.com/praetorian-inc/aurelian/blob/main/README.md](https://github.com/praetorian-inc/aurelian/blob/main/README.md)
- [https://github.com/praetorian-inc/aurelian/tree/main/docs](https://github.com/praetorian-inc/aurelian/tree/main/docs)
- [https://github.com/praetorian-inc/aurelian/releases](https://github.com/praetorian-inc/aurelian/releases)
...
- [https://pkg.go.dev/github.com/praetorian-inc/aurelian](https://pkg.go.dev/github.com/praetorian-inc/aurelian)
...
2. SKILL.md Content (`.cursor\skills\Aurelian\SKILL.md`): Deconstruct the workflows from source docs into clear, step-by-step instructions for the AI. Organize it using the following headers:
...
3. References Directory (`.cursor\skills\Aurelian\references`): A directory of references to source material and usage, indexed through `SKILLS.md`.
4. Zero to Hero Document (`.docs\docs-for-cli-tools\Aurelian-Zero-to-Hero.md`): A markdown document that takes the user from zero to hero in using Aurelian.
5. CLI Options Documentation (`.docs\docs-for-cli-tools\Aurelian-CLI-Options.md`): A markdown document that lists standard and advanced Aurelian CLI options.
