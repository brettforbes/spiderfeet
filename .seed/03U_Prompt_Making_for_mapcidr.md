# Creating a Skill and Documentation for mapcidr, Scanning Networks and Systems

I want you to help me author an AI Agent Skill for my library.

## Goal

Create a SKILL.md file and a precise trigger description for mapcidr, when we are scanning networks and systems.

This skill will teach you how to use mapcidr in different reconnaissance and analysis scenarios.

You will use this skill to exercise mapcidr in different scenarios, and over time you will update it with your learnings and insights.
...
- [https://github.com/projectdiscovery/mapcidr](https://github.com/projectdiscovery/mapcidr)
- [https://github.com/projectdiscovery/mapcidr/blob/main/README.md](https://github.com/projectdiscovery/mapcidr/blob/main/README.md)
- [https://github.com/projectdiscovery/mapcidr/releases](https://github.com/projectdiscovery/mapcidr/releases)

Developer references:

- [https://pkg.go.dev/github.com/projectdiscovery/mapcidr](https://pkg.go.dev/github.com/projectdiscovery/mapcidr)

Supplementary references:

- [https://github.com/projectdiscovery/mapcidr/issues/48](https://github.com/projectdiscovery/mapcidr/issues/48)
...
2. SKILL.md Content (`.cursor\skills\mapcidr\SKILL.md`): Deconstruct the workflows from source docs into clear, step-by-step instructions for the AI. Organize it using the following headers:
...
3. References Directory (`.cursor\skills\mapcidr\references`): A directory of references to source material and usage, indexed through `SKILLS.md`.
4. Zero to Hero Document (`.docs\docs-for-cli-tools\mapcidr-Zero-to-Hero.md`): A markdown document that takes the user from zero to hero in using mapcidr.
5. CLI Options Documentation (`.docs\docs-for-cli-tools\mapcidr-CLI-Options.md`): A markdown document that lists standard and advanced mapcidr CLI options.
