# Creating a Skill and Documentation for Pius, Scanning Networks and Systems
...
- [Pius GitHub Repo](https://github.com/praetorian-inc/pius)
...
- [Attack Surface Management with Pius: A Comprehensive Guide](https://www.linkedin.com/posts/praetorian_offensivesecurity-attacksurfacemanagement-activity-7438266584684457984-GYf_)
...
2. SKILL.md Content (`.cursor\skills\pius\SKILL.md`): Deconstruct the workflows from my help docs into clear, step-by-step instructions for the AI. Organize it using the following headers:
...
3. References Directory (`.cursor\skills\pius\references`): A directory of references to the source material and how to use the tool, indexed through the `SKILLS.md` file.
4. Zero to Hero Document (`.docs\docs-for-cli-tools\PIUS-Zero-to-Hero.md`): A markdown docuemnt that takes the user from zero to hero in using Pius to scan networks and systems.
5. CLI Options Documentation (`.docs\docs-for-cli-tools\PIUS-CLI-Options.md`): A markdown document that lists the standard Pius CLI Options doc
