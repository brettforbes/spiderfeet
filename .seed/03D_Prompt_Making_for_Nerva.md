# Creating a Skill and Documentation for Nerva, Scanning Services and Systems

I want you to help me author an AI Agent Skill for my library.

## Goal

Create a SKILL.md file and a precise trigger description for Nerva, When we are scanning networks and systems using Nerva we will save output in the JSON format, and convert those results to nested nuggets.
...
You will use this skill to exercise Nerva in different scenarios, and over time you will update it with your learnings and insights.
...
- [Nerva Repo](https://github.com/praetorian-inc/nerva)
- [Nerva Documentation](https://github.com/praetorian-inc/nerva/wiki)
- [Protocol List](https://github.com/praetorian-inc/nerva/wiki/Protocol-List)
...
- [I Built an Open-Source Service Fingerprinter — Here’s What It Finds](https://medium.com/@praetorianguard/i-built-an-open-source-service-fingerprinter-heres-what-it-finds-0daae3ccc74a)
...
2. SKILL.md Content (`.cursor\skills\nerva\SKILL.md`): Deconstruct the workflows from my help docs into clear, step-by-step instructions for the AI. Organize it using the following headers:
...
3. References Directory (`.cursor\skills\nerva\references`): A directory of references to the source material and how to use the tool, indexed through the `SKILLS.md` file.
4. Zero to Hero Document (`.docs\docs-for-cli-tools\Nerva-Zero-to-Hero.md`): A markdown docuemnt that takes the user from zero to hero in using Nerva, Scanning Services and Systems, including using each of the modules in a coordinated, orchestrated manner to maximise the resulting data from any network, regardless of how its systems seek to defeat your scan.
5. CLI Options Documentation (`.docs\docs-for-cli-tools\Nerva-CLI-Options.md`): A markdown document that lists the standard Nerva CLI Options doc for each of the modules to make a comprehensive summary of the options for each module.
