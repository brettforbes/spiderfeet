#!/usr/bin/env python3
"""Subfinder structured JSON helpers and structured→text conversion."""
...
def subfinder_text_capture_header(
    *,
    command: str,
    scenario_name: str,
    scenario_id: str,
    ...
    return (
        ...
        f"# enumeration_mode: {scan['enumeration_mode']}\n"
        ...
        f"# host_summary_lines: {scan['host_summary_lines']}\n"
