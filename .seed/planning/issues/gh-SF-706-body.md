## Problem
Module `sfp_venmo` has no smoke-validated entry in `module_test_seeds.json` (none-tier corpus gap).
...
- **Produces:** RAW_RIR_DATA, HUMAN_NAME

## Research tasks
1. Inspect `modules/sfp_venmo.py` for required input shape and external API health.
