## Problem
Module `sfp_crobat_api` has no smoke-validated entry in `module_test_seeds.json` (none-tier corpus gap).
...
- **Produces:** RAW_RIR_DATA, INTERNET_NAME, INTERNET_NAME_UNRESOLVED

## Research tasks
1. Inspect `modules/sfp_crobat_api.py` for required input shape and external API health.
