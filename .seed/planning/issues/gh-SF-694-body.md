## Problem
Module `sfp_onionsearchengine` has no smoke-validated entry in `module_test_seeds.json` (none-tier corpus gap).
...
- **Produces:** DARKNET_MENTION_URL, DARKNET_MENTION_CONTENT

## Research tasks
1. Inspect `modules/sfp_onionsearchengine.py` for required input shape and external API health.
