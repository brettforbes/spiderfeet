## Problem
Module `sfp_bgpview` has no smoke-validated entry in `module_test_seeds.json` (none-tier corpus gap).
...
- **Produces:** BGP_AS_MEMBER, NETBLOCK_MEMBER, NETBLOCKV6_MEMBER, PHYSICAL_ADDRESS, RAW_RIR_DATA

## Research tasks
1. Inspect `modules/sfp_bgpview.py` for required input shape and external API health.
