## Problem
Module `sfp_myspace` has no smoke-validated entry in `module_test_seeds.json` (none-tier corpus gap).
...
- **Produces:** SOCIAL_MEDIA, GEOINFO

## Research tasks
1. Inspect `modules/sfp_myspace.py` for required input shape and external API health.
