## Problem
Module `sfp_keybase` has no smoke-validated entry in `module_test_seeds.json` (none-tier corpus gap).
...
- **Produces:** RAW_RIR_DATA, SOCIAL_MEDIA, USERNAME, GEOINFO, BITCOIN_ADDRESS, PGP_KEY

## Research tasks
1. Inspect `modules/sfp_keybase.py` for required input shape and external API health.
