# Creating a Skill and Documentation for webanalyze, Scanning Networks and Systems

I want you to help me author an AI Agent Skill for my library.

## Goal

Create a SKILL.md file and a precise trigger description for webanalyze, when we are scanning networks and systems.

This skill will teach you how to use webanalyze in different reconnaissance and analysis scenarios.

You will use this skill to exercise webanalyze in different scenarios, and over time you will update it with your learnings and insights.
...
- [https://github.com/rverton/webanalyze/blob/master/README.md](https://github.com/rverton/webanalyze/blob/master/README.md)
- [https://github.com/rverton/webanalyze/releases](https://github.com/rverton/webanalyze/releases)

Fingerprint ecosystem:

- [https://github.com/wappalyzer/wappalyzer](https://github.com/wappalyzer/wappalyzer)
- [https://github.com/wappalyzer/wappalyzer/blob/master/schema.json](https://github.com/wappalyzer/wappalyzer/blob/master/schema.json)

Supplementary guides:

- [https://www.rootsec.in/tools/technology-detection/fingerprinting/webanalyze](https://www.rootsec.in/tools/technology-detection/fingerprinting/webanalyze)
...
2. SKILL.md Content (`.cursor\skills\webanalyze\SKILL.md`): Deconstruct the workflows from source docs into clear, step-by-step instructions for the AI. Organize it using the following headers:
...
3. References Directory (`.cursor\skills\webanalyze\references`): A directory of references to source material and usage, indexed through `SKILLS.md`.
4. Zero to Hero Document (`.docs\docs-for-cli-tools\webanalyze-Zero-to-Hero.md`): A markdown document that takes the user from zero to hero in using webanalyze.
5. CLI Options Documentation (`.docs\docs-for-cli-tools\webanalyze-CLI-Options.md`): A markdown document that lists standard and advanced webanalyze CLI options.
