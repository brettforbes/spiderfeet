# Creating a Skill and Documentation for dnsx, Scanning Networks and Systems

I want you to help me author an AI Agent Skill for my library.

## Goal

Create a SKILL.md file and a precise trigger description for dnsx, when we are scanning networks and systems.

This skill will teach you how to use dnsx in different reconnaissance and analysis scenarios.

You will use this skill to exercise dnsx in different scenarios, and over time you will update it with your learnings and insights.
...
- [https://docs.projectdiscovery.io/opensource/dnsx/overview](https://docs.projectdiscovery.io/opensource/dnsx/overview)
- [https://docs.projectdiscovery.io/opensource/dnsx/usage](https://docs.projectdiscovery.io/opensource/dnsx/usage)
- [https://github.com/projectdiscovery/dnsx](https://github.com/projectdiscovery/dnsx)
- [https://github.com/projectdiscovery/dnsx/releases](https://github.com/projectdiscovery/dnsx/releases)
...
- [https://www.kali.org/tools/dnsx/](https://www.kali.org/tools/dnsx/)

Developer references:

- [https://pkg.go.dev/github.com/projectdiscovery/dnsx](https://pkg.go.dev/github.com/projectdiscovery/dnsx)
...
2. SKILL.md Content (`.cursor\skills\dnsx\SKILL.md`): Deconstruct the workflows from source docs into clear, step-by-step instructions for the AI. Organize it using the following headers:
...
3. References Directory (`.cursor\skills\dnsx\references`): A directory of references to source material and usage, indexed through `SKILLS.md`.
4. Zero to Hero Document (`.docs\docs-for-cli-tools\dnsx-Zero-to-Hero.md`): A markdown document that takes the user from zero to hero in using dnsx.
5. CLI Options Documentation (`.docs\docs-for-cli-tools\dnsx-CLI-Options.md`): A markdown document that lists standard and advanced dnsx CLI options.
