"""Open a TypeDB driver from spiderfeet_v2 connection config."""
...
from spiderfeet_v2.db.config import TypeDBConnectionConfig
...
def database_exists(
    ...
    """Return True when the configured actual database exists on the server."""
