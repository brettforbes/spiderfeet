...
HTML5 only — for **spiderfeet-widget** iframe embeds. Wire behaviour via `window.Widgets.*` and `Widgets.Events`; see `widget-iframe-integration.md` and `viz-canvas-layout.md`.
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <!-- Content area (inject map sidebar / viz stage here) -->
