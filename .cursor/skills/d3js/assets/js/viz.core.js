...
(function (global) {
  ...
  const Core = {
    selectSvg(svgElement) {
      const el = typeof svgElement === 'string'
    ...
    rootGroup(svgSelection, margin) {
      return svgSelection
        .attr('width', margin.left + margin.right + (svgSelection.node()?.clientWidth || 800) - margin.left - margin.right)
        .append('g')
