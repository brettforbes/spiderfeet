...
from spiderfeet.api.routes import catalogue, health, map, scan_ui, scans, tests
...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        description="REST API for SpiderFeet scans, catalogue data, TypeDB map, and module tests (Stages 2–4).",
        version=__version__,
        docs_url="/docs",
        redoc_url="/redoc",
